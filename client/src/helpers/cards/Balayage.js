export default class Balayage {
    constructor(scene) {

        let name = "Balayage";
        const id = 19;
        const speed = 0;
        let description = "Inflige 9 points de dégâts. Vous passez en stance Debout et votre adversaire à Genoux.";
        let descriptionBAX = "Inflige 9 points de dégâts. Vous passez en stance Debout et votre adversaire au Sol.";
        const mindSetUser=[];
        const stanceUser = [1,0,0,0,0,0,0,0,0];
        const mindSetOpponent = [];
        const stanceOpponent = [0,1,0,0,0,0,0,0,0];
        const hpUser = 0;
        const staminaUser = -9;
        const hpOpponent = -9;
        const staminaOpponent = 0;
        let animationUser = 'balayageUser';
        let animationOpponent = 'balayageOpponent';
        let son = "balayage";
