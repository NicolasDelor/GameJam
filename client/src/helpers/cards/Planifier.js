export default class Planifier {
    constructor(scene) {
        
        let name = "Planifier";
        const id = 8;
        const speed = -2;
        let description = "Votre action du prochain tour a +5 en vitesse.";
        let descriptionBAX = "Votre action du prochain tour a +5 en vitesse et votre adversaire doit annoncer son action avant que vous ne choisissiez la vôtre.";
        const mindSetUser=[];
        const stanceUser = [];
