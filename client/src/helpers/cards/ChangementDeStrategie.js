export default class ChangementDeStrategie {
    constructor(scene) {

        let name = "Changement de stratégie";
        const id = 24;
        const speed = -1;
        let description = "Changez obligatoirement de Mindset.";
        let descriptionBAX = "Changez de Mindset. Votre action du prochain tour a vitesse +2.";
        const mindSetUser=[];
        const stanceUser = [];
        ...
        let animationUser = 'changementStratUser';
        let animationOpponent = 'changementStratOpponent';
        let son = "attente";
