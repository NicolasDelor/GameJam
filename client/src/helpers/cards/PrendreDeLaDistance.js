export default class PrendreDeLaDistance {
    constructor(scene) {
        
        let name = "Prendre de la distance";
        const id = 14;
        const speed = 0;
        let description = "Vous et votre adversaire passez en Stance à distance.";
        let descriptionBAX = "Vous et votre adversaire passez en Stance à distance. Regagnez 5 Stamina.";
        const mindSetUser=[];
