export default class ViserLaOuCaFaitMal {
    constructor(scene) {

        let name = "Viser la où ca fait mal";
        const id = 18;
        const speed = 1;
        let description = "Inflige 12 points de dégâts.";
        let descriptionBAX = "Inflige 12 points de dégâts. Placez un marqueur étourdissement sur votre adversaire.";
        const mindSetUser=[];
        const stanceUser = [];
        ...
        let animationUser = 'viserlaouUser';
        let animationOpponent = 'viserlaouOpponent';
        let son = "attente";
