export default class Trébucher {
    constructor(scene) {
        
        let name = "Trébucher";
        const id = 11;
        const speed = -2;
        let description = "Vous passez en Stance au Sol. Vous ne pouvez pas changer de Mindset jusqu’à la fin du prochain tour.";
        let descriptionBAX = "Vous passez en Stance au Sol. Vous ne pouvez pas changer de Mindset jusqu’à la fin du prochain tour. Votre action du prochain tour a +2 en vitesse.";
        const mindSetUser=[];
        const stanceUser = [0,0,1,0,0,0,0,0,0];
