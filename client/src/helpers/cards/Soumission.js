export default class Soumission {
    constructor(scene) {
        
        let name = "Soumission  ";
        const id = 13;
        const speed = 0;
        let description = "Placez un marqueur humiliation sur vous. Votre action du prochain tour a +2 en vitesse. Ne placez pas de marqueur si vous êtes en sournoiserie. ";
        let descriptionBAX = "Placez un marqueur sur vous et votre adversaire.";
        const mindSetUser=[];
        const stanceUser = [];
