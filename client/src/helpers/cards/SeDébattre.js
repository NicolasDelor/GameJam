export default class SeDebattre {
    constructor(scene) {

        let name = "Se débattre";
        const id = 22;
        const speed = 0;
        let description = "Si vous gagnez strictement un lancer de d6 contre votre adversaire, passez tous les deux en Stance Debout.";
        let descriptionBAX = "Si vous gagnez un lancer de d6 contre votre adversaire, passez tous les deux en Stance Debout. Placez un jeton étourdissement sur votre adversaire.   ";
        const mindSetUser=[];
        const stanceUser = [];
        ...
        let animationUser = 'seDebattreUser';
        let animationOpponent = 'seDebattreOpponent';
        let son = "attente";
