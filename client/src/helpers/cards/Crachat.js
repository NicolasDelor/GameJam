export default class Crachat {
    constructor(scene) {
        
        let name = "Crachat";
        const id = 12;
        const speed = 0;
        let description = "Placez un marqueur humiliation sur votre adversaire. Cette action échoue si votre adversaire a changé de Stance pendant ce tour.";
        let descriptionBAX = "Placez un marqueur humiliation sur votre adversaire.";
        const mindSetUser=[];
        const stanceUser = [];
