export default class BriserLIntimité {
    constructor(scene) {

        let name = "Briser l’intimité";
        const id = 10;
        const speed = 1;
        let description = "Infligez 18 dégâts.";
        let descriptionBAX = "Infligez 18 dégâts. Il passe en Stance au Sol.";
        const mindSetUser=[];
        const stanceUser = [];
