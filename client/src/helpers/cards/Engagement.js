export default class Engagement {
    constructor(scene) {
        ...
        const id = 16;
        const speed = 1;
        let description = "Vous et votre adversaire passez en Stance Au contact. Vous ne pouvez changer de Stance jusqu’à la fin du prochain tour.";
        let descriptionBAX = "Infligez 7 points de dégâts. Vous et votre adversaire passez en Stance au contact et ne pouvez changer de Stance jusqu’à la fin du prochain tour. ";
        const mindSetUser=[];
        const stanceUser = [0,0,0,0,1,0,0,0,0];
        const mindSetOpponent = [];
        const stanceOpponent = [0,0,0,0,1,0,0,0,0];
        const hpUser = 0;
        const staminaUser = -6;
        const hpOpponent = 0;
