export default class MaîtriseTotale {
    constructor(scene) {

        let name = "Maîtrise Totale";
        const id = 2;
        const speed = 0;
        let description = "Finisher. Si votre adversaire a moins de 10 pdv et ne vous a pas infligé de dégâts depuis deux actions, vous le mettez hors combat.";
        let descriptionBAX = "Finisher. Si votre adversaire a moins de la moitié de sa vie et ne vous a pas infligé de dégâts depuis deux actions, vous le mettez hors combat.";
        ...
        const forceStanceOpponent = [0,0,1,0,0,0,0,0,0];
