export default class FrapperPourTuer {
    constructor(scene) {

        let name = "Frapper pour tuer";
        const id = 1;
        const speed = 2;
        let description = "Finisher. Si votre adversaire a 0 pdv, vous le tuez. De Manière violente.";
        let descriptionBAX = "Finisher. Si votre adversaire a 0 pdv, vous le tuez. De Manière violente. Ignorez le cout en Stamina.";
