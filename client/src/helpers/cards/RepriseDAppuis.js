export default class RepriseDAppuis {
    constructor(scene) {
        
        let name = "Reprise d'appuis";
        const id = 9;
        const speed = -1;
        let description = "Vous passez en Stance debout.";
        let descriptionBAX = "Vous passez en Stance debout. Vous pouvez changer de Mindset si vous le désirez.";
        const mindSetUser=[];
