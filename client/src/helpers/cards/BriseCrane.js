export default class BriseCrane {
    constructor(scene) {

        let name = "Brise Crâne";
        const id = 20;
        const speed = 0;
        let description = "Inflige 20 points de dégâts. ";
        let descriptionBAX = "Inflige 20 points de dégâts. Votre adversaire perd 8 Stamina.";
        const mindSetUser=[];
        const stanceUser = [];
        const mindSetOpponent = [];
        const stanceOpponent = [];
        const hpUser = 0;
        const staminaUser = -11;
        const hpOpponent = -20;
        const staminaOpponent = 0;
        let animationUser = 'briseCraneUser';
        let animationOpponent = 'briseCraneOpponent';
        let son = "balayage";
